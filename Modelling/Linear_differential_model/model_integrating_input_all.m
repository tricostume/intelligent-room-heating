...
%Integral transmittance  and integral mathematical gain
%(to be finely tuned)
Ki = 10;
Gi = 0.002;
xdot = [
...
% Bedrooms
(1/c0)*(Ku*u0 + Ki*ui0 - q0_e - q0_2 -q0_11);
(1/c1)*(Ku*u1 + Ki*ui1 - q1_e - q1_3 -q1_11); % Add integrating control
(1/c2)*(Ku*u2 + Ki*ui2 - q2_e + q0_2 -q2_4 - q2_11);
(1/c3)*(Ku*u3 + Ki*ui3 - q3_e + q1_3 -q3_5 - q3_11);
(1/c4)*(Ku*u4 + Ki*ui4 - q4_e + q2_4 -q4_6 - q4_11);
(1/c5)*(Ku*u5 + Ki*ui5 - q5_e + q3_5 -q5_7 - q5_11);
(1/c6)*(Ku*u6 + Ki*ui6 - q6_e + q4_6 -q6_9 - q6_11);
(1/c7)*(Ku*u7 + Ki*ui7 - q7_e + q5_7 -q7_8 - q7_11);
(1/c8)*(Ku*u8 + Ki*ui8 - q8_e + q7_8 -q8_11);
(1/c9)*(Ku*u9 + Ki*ui9 - q9_e + q6_9 -q9_10 - q9_11);
% Lounge
(1/c10)*(2*Ku*u10 + Ki*ui10 - q10_e + q9_10 -q10_11);
% Corridor
(1/c11)*(2*Ku*u11 + Ki*ui11 - q11_e + q0_11 + q1_11 + q2_11 + q3_11 + q4_11 + q5_11 + ... 
