function [xdot] = model_trial_no_integral(x, u, uc, Te, qS,P, lambda)
...
% Rooms' temperature
T0 = x(1); u0 = u(1)*(20-x(1)); uc0=uc(1)*(26-x(1));
T1 = x(2); u1 = u(2)*(20-x(2)); uc1=uc(2)*(26-x(2));
T2 = x(3); u2 = u(3)*(20-x(3)); uc2=uc(3)*(26-x(3));
T3 = x(4); u3 = u(4)*(20-x(4)); uc3=uc(4)*(26-x(4));
T4 = x(5); u4 = u(5)*(20-x(5)); uc4=uc(5)*(26-x(5));
T5 = x(6); u5 = u(6)*(20-x(6)); uc5=uc(6)*(26-x(6));
T6 = x(7); u6 = u(7)*(20-x(7)); uc6=uc(7)*(26-x(7));
T7 = x(8); u7 = u(8)*(20-x(8)); uc7=uc(8)*(26-x(8));
T8 = x(9); u8 = u(9)*(20-x(9)); uc8=uc(9)*(26-x(9));
T9 = x(10); u9 = u(10)*(20-x(10)); uc9=uc(10)*(26-x(10));
% Lounge temperature
...
% Bedrooms
% (1/c0)*(Ku0*u0 + Kuc0*uc0 + qS0 - q0_e - q0_2 -q0_11);
% (1/c1)*(Ku1*u1 + Kuc1*uc1 + qS1 - q1_e - q1_3 -q1_11); % Add integrating control
% (1/c2)*(Ku2*u2 + Kuc2*uc2 + qS2 - q2_e + q0_2 -q2_4 - q2_11);
% (1/c3)*(Ku3*u3 + Kuc3*uc3 + qS3 - q3_e + q1_3 -q3_5 - q3_11);
% (1/c4)*(Ku4*u4 + Kuc4*uc4 + qS4 - q4_e + q2_4 -q4_6 - q4_11);
% (1/c5)*(Ku5*u5 + Kuc5*uc5 + qS5 - q5_e + q3_5 -q5_7 - q5_11);
% (1/c6)*(Ku6*u6 + Kuc6*uc6 + qS6 - q6_e + q4_6 -q6_9 - q6_11);
% (1/c7)*(Ku7*u7 + Kuc7*uc7 + qS7 - q7_e + q5_7 -q7_8 - q7_11);
% (1/c8)*(Ku8*u8 + Kuc8*uc8 + qS8 - q8_e + q7_8 -q8_11);
% (1/c9)*(Ku9*u9 + Kuc9*uc9 + qS9 - q9_e + q6_9 -q9_10 - q9_11);
(1/c0)*(Ku0*u0 + qS0 - q0_e - q0_2 -q0_11);
(1/c1)*(Ku1*u1 + qS1 - q1_e - q1_3 -q1_11); % Add integrating control
(1/c2)*(Ku2*u2 + qS2 - q2_e + q0_2 -q2_4 - q2_11);
(1/c3)*(Ku3*u3 + qS3 - q3_e + q1_3 -q3_5 - q3_11);
(1/c4)*(Ku4*u4 + qS4 - q4_e + q2_4 -q4_6 - q4_11);
(1/c5)*(Ku5*u5 + qS5 - q5_e + q3_5 -q5_7 - q5_11);
(1/c6)*(Ku6*u6 + qS6 - q6_e + q4_6 -q6_9 - q6_11);
(1/c7)*(Ku7*u7 + qS7 - q7_e + q5_7 -q7_8 - q7_11);
(1/c8)*(Ku8*u8 + qS8 - q8_e + q7_8 -q8_11);
(1/c9)*(Ku9*u9 + qS9 - q9_e + q6_9 -q9_10 - q9_11);
% Lounge
(1/c10)*(Ku10*u10 + Kuc10*uc10 + qS10 - q10_e + q9_10 -q10_11);
% Corridor
(1/c11)*(Ku11*u11 + Kuc11*uc11 + qS11 - q11_e + q0_11 + q1_11 + q2_11 + q3_11 + q4_11 + q5_11 + ... 
