...
counter_4ernesto = 0 + pidG1 + pidG2;
counter_other = 0;
counter2 = 0;
counter3 = 0;
counter4 = 0;
...
for i = 1 : cells
    for j = 1 : cells
        ...
        if hotel_matrix (i,j,f) == 2
            counter2 = counter2 + 1;
            counter_4ernesto = counter_4ernesto +1;
            
            room(i,j,f).c4ernesto = counter_4ernesto;
            room(i,j,f).id = hotel_matrix (i,j,f); %room_temp(i,j,f).id = room(i,j,f).id;
